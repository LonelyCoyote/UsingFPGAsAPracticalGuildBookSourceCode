...
# JP1-3 
set_property PACKAGE_PIN H1 [get_ports {s[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {s[0]}]

# JP1-4 
set_property PACKAGE_PIN H2 [get_ports {s[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {s[1]}]

# JP1-5 
set_property PACKAGE_PIN G1 [get_ports {s[2]}]
...
# JP1-7 
set_property PACKAGE_PIN F2 [get_ports {b[0]}]
...
# JP1-9 
set_property PACKAGE_PIN E2 [get_ports {output}]
