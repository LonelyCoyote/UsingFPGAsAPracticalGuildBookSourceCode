...
## JP3-5 
set_property PACKAGE_PIN C8 [get_ports {B}]
set_property IOSTANDARD LVCMOS33 [get_ports {B}]

## JP3-6 
set_property PACKAGE_PIN D10 [get_ports {C}]
set_property IOSTANDARD LVCMOS33 [get_ports {C}]

## JP3-7 
set_property PACKAGE_PIN A9 [get_ports {D}]
set_property IOSTANDARD LVCMOS33 [get_ports {D}]

## JP3-8 
set_property PACKAGE_PIN C9 [get_ports {E}]
...
## JP3-11 
set_property PACKAGE_PIN B9 [get_ports {F}]
set_property IOSTANDARD LVCMOS33 [get_ports {F}]

## JP3-12 
set_property PACKAGE_PIN A10 [get_ports {G}]
set_property IOSTANDARD LVCMOS33 [get_ports {G}]

## JP3-13 
set_property PACKAGE_PIN B10 [get_ports {DP}]
set_property IOSTANDARD LVCMOS33 [get_ports {DP}]

## JP3-14 
set_property PACKAGE_PIN C11 [get_ports {Digit1}]
set_property IOSTANDARD LVCMOS33 [get_ports {Digit1}]

## JP3-15 
set_property PACKAGE_PIN B12 [get_ports {Digit2}]
set_property IOSTANDARD LVCMOS33 [get_ports {Digit2}]

## JP3-16 
set_property PACKAGE_PIN A12 [get_ports {Digit3}]
set_property IOSTANDARD LVCMOS33 [get_ports {Digit3}]

## JP3-17 
set_property PACKAGE_PIN C12 [get_ports {Digit4}]
set_property IOSTANDARD LVCMOS33 [get_ports {Digit4}]

## JP3-18 
set_property PACKAGE_PIN F13 [get_ports {one_wire}]
...
## JP3-21 
set_property PACKAGE_PIN A13 [get_ports {adc_clk}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_clk}]

## JP3-22 
set_property PACKAGE_PIN A14 [get_ports {adc_data}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_data}]

## JP3-23 
set_property PACKAGE_PIN E13 [get_ports {adc_ncs}]
