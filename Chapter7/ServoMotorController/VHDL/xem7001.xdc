...
## JP3-4 
set_property PACKAGE_PIN D9 [get_ports {pwm}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm}]

## JP3-5 
set_property PACKAGE_PIN C8 [get_ports {adc_clk}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_clk}]

## JP3-6 
set_property PACKAGE_PIN D10 [get_ports {adc_data}]
set_property IOSTANDARD LVCMOS33 [get_ports {adc_data}]

## JP3-7 
set_property PACKAGE_PIN A9 [get_ports {adc_ncs}]
